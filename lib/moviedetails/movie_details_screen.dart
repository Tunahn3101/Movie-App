...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      movieDetailsProvider.loadCastData(movieId);
      movieDetailsProvider.loadReviewsData(movieId);
    });
  ...
  void handleSaveMovie(BuildContext context, int movieId) async {
    final authProvider = Provider.of<LibraryProvider>(context, listen: false);
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Expanded(
                      child: segmentWidgets[selectedSegmentIndex],
                    ),
                  ],
                ),
              ),
